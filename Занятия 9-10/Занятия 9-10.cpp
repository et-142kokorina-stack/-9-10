...
void print(film movies[], int k) { 
    ...
    printf("%-20s %-20s %-20s %-15s %-6s %-7s %-5s %-7s %-10s %-10s %-20s\n",
    ...
    for (int i = 0; i < k; i++) {
        ...
        printf("%-20s %-20s %-20s %-15s %-6d %-7d %-5d %-7d %-10d %-10.1f %-20s\n",
            movies[i].name.c_str(),
...
film* init() { 
    ...
    movies[10] = { "Паразиты", { "Пон Джун", "Хо" }, THRILLER, { 2019, 5, 30 }, 132, 154, 8.2, "Сон Кан Хо" };
